...
st.write('[![view source code ](https://img.shields.io/badge/view_source_code-gray?logo=github)](https://github.com/codebloodedd/AskNova/blob/main/pages/5_%F0%9F%9B%A2_chat_with_sql_db.py)')
